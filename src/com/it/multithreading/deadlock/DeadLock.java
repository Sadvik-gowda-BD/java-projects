package com.it.multithreading.deadlock;
...
main issue. To solve the issue we will have to simply re-order the statements where the code is accessing shared resources.
