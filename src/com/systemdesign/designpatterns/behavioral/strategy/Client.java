package com.systemdesign.designpatterns.behavioral.strategy;

public class Client {

    public static void main(String[] args) {
        SortingContextWithStrategy sortingContext = new SortingContextWithStrategy(new BubbleSortStrategy());
